...
SIMULATION_START = datetime(2022, 8, 24, 14, 0).astimezone(AMSTERDAM)


def get_model_and_simulation_name(schematisation_name: str, bui: str):
    # find model
...
def start_simulatie(
    ...
    if bui == "XXmm":
        ...
        raise ValueError("Kies '35mm' of '100mm' als bui")
